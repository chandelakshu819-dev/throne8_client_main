//src/features/mentorship/components/PaymentStep.tsx
"use client";
...
const BYPASS_PAYMENT = true; // 👈 testing ke baad isko false kar dena
...
const PaymentStep: React.FC<PaymentStepProps> = ({
    ...
    const handleBookSession = async (overrideMethod?: string) => {
        ...
        try {
            ...
            await SessionService.bookSession({
                ...
                paymentMethod: paymentMethodMap[methodToUse] || "razorpay",
                pricing: {
                    basePrice: price,
    ...
    useEffect(() => {
        if (BYPASS_PAYMENT) {
            handleBookSession("wallet");
        }
        // eslint-disable-next-line react-hooks/exhaustive-deps
    }, []);

    // Booking loader screen
    if (booking || BYPASS_PAYMENT) {
        return (
