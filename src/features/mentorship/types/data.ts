// components/mentor-profile/data.ts

import { MentorData, Service, Review, PayMethod } from "@/features/mentor/interface";
import React from "react";
// import type { MentorData, Service, Review, PayMethod } from "./types/types";
