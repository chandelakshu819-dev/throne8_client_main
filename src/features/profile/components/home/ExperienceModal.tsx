    ...
    import { Loader2, X, Briefcase, Calendar, Image as ImageIcon, Award, Edit3, PlusCircle, Sparkles, Check } from 'lucide-react';
        ...
        return (
            <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
                <div className="bg-gradient-to-br from-[#f6ede8] to-[#f0e6d8] rounded-2xl shadow-2xl border border-[#e0d8cf] max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                    {/* Header */}
                    <div className="sticky top-0 bg-[#f6ede8] border-b border-[#e0d8cf] px-6 py-4 flex items-center justify-between z-10">
                        <div>
                            <h3 className="text-2xl font-bold text-[#4a3728] flex items-center gap-2">
                                {isEditing ? (
                                    <>
                                        <Edit3 className="w-5 h-5 text-[#4a3728]" /> Edit Experience
                                    </>
                                ) : (
                                    <>
                                        <PlusCircle className="w-5 h-5 text-[#4a3728]" /> Add New Experience
                                    </>
                                )}
                            </h3>
                    ...
                    <div className="p-6 space-y-4">
                        ...
                        <div>
                            ...
                            <div className="bg-white/50 p-4 rounded-lg border border-[#d4c4b5] space-y-3">
                                ...
                                <p className="text-xs text-[#8b6f47] flex items-center gap-1.5 mt-2">
                                    <Sparkles className="w-3.5 h-3.5 text-[#8b6f47] flex-shrink-0" />
                                    <span><span className="font-semibold text-[#4a3728]">Tip:</span> Add 3-5 key achievements to highlight your impact.</span>
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    {/* Footer / Actions */}
                    <div className="sticky bottom-0 bg-[#f6ede8] border-t border-[#e0d8cf] px-6 py-4 flex justify-end gap-3 z-10">
                        <button
                            onClick={onClose}
                            disabled={isSaving}
